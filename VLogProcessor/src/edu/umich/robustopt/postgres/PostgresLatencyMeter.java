...
public class PostgresLatencyMeter extends LatencyMeter {

	private PostgresDatabaseLoginConfiguration postgresLogin;
	private PostgresDeployer postgresDeployer;

	public PostgresLatencyMeter(LogLevel verbosity,
		...
		try {
			postgresDeployer = new PostgresDeployer(verbosity, databaseLogin, experimentCache, false);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
